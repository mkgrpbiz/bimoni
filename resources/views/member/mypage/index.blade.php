...
<div class="py-2">
    ...
    <div class="bg-gradient-to-r from-pink-500 to-pink-400 text-white rounded-2xl p-5 mb-5 shadow-md">
        ...
        <p class="text-pink-100 text-xs mb-2 text-center">ポイント還元 支払い予定（1P＝1円）</p>
    ...
    <div class="space-y-3 mb-5">
        <a href="{{ route('member.referral_program') }}"
           class="block bg-gradient-to-r from-amber-400 to-pink-400 text-white py-3 rounded-xl text-sm font-medium text-center shadow-sm">
            🎁 お友達紹介プログラム
        </a>
