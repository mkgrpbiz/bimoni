...
<form method="GET" class="bg-white dark:bg-gray-800 rounded-lg shadow p-3 mb-4 flex gap-3 items-end flex-wrap">
    ...
    <div>
        ...
        <input type="text" name="q" value="{{ request('q') }}" placeholder="ユーザーID/LINE名/氏名/フリガナ"
               class="border dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded px-2 py-1 text-sm w-52">
    </div>
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-x-auto">
    <table class="w-full text-xs">
        ...
        <tbody class="divide-y dark:divide-gray-700">
            ...
            <tr class="{{ $unlinked ? 'bg-red-50 hover:bg-red-100' : 'even:bg-gray-50 hover:bg-gray-100 dark:hover:bg-gray-750' }}">
