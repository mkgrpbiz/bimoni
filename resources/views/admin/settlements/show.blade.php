...
<div class="flex items-center gap-3 mb-6">
    <a href="{{ route('admin.settlements.index') }}" class="text-gray-400 hover:text-gray-600">← 締め一覧</a>
    ...
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y dark:divide-gray-700">
            ...
            <tr>
                ...
                <td class="px-4 py-3 text-gray-600 dark:text-gray-400">{{ $point->reason ?? '-' }}</td>
