...
<div class="bg-white rounded-lg shadow overflow-x-auto">
    <table class="w-full text-sm">
        ...
        <tbody id="sortable-campaigns" class="divide-y">
            ...
            <tr class="even:bg-gray-50 hover:bg-gray-100 cursor-default" data-id="{{ $campaign->id }}">
                ...
                <td class="px-3 py-3">
                    <div class="flex gap-1 justify-center flex-wrap">
                        <a href="{{ route('admin.campaigns.applications', $campaign) }}"
                           class="text-xs bg-yellow-500 text-white px-2 py-1 rounded hover:bg-yellow-600">応募</a>
