...
<div class="bg-white rounded-lg shadow p-6 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
    ...
    <div>
        <span class="text-gray-700">ポイント還元：</span>
    ...
    <div>
        <span class="text-gray-700">継続ポイント還元：</span>
    ...
    <div><span class="text-gray-700">回収必須（継続）：</span>{{ $campaign->collection_requirement ?? '-' }}</div>
