        ...
        <div class="space-y-3">
            <template x-for="(course, index) in courses" :key="index">
                <div class="course-row border rounded-lg p-3 space-y-2">
                    ...
                    {{-- 2行目: 単発/継続前提・継続条件・継続購入費2/3（継続前提用）／継続判定の有無・目標継続率（単発用） --}}
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                        <div class="md:col-span-2">
                        ...
                        {{-- 継続前提: 継続が確定しているコース。回数と各回の購入費のみ設定する（判定不要） --}}
                        ...
                        {{-- 単発: 継続前提とは無関係に、実際に継続するか任意で判定・追跡したい場合に使う --}}
                        <template x-if="course.course_type === '単発'">
                            <div class="md:col-span-2">
