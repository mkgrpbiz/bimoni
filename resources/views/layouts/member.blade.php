...
<body class="bg-gray-50 min-h-screen pb-20">
    ...
    <div id="line-friend-modal" class="fixed inset-0 bg-black bg-opacity-60 z-[100] hidden items-center justify-center">
        <div class="bg-white rounded-2xl p-8 mx-4 max-w-sm w-full text-center shadow-xl">
            ...
            <h2 class="text-lg font-bold text-gray-800 mb-2">BIMONI公式</h2>
            <p class="text-gray-700 text-sm mb-1">LINE追加してください</p>
            <p class="text-gray-400 text-xs mb-6">※案内は全てLINEで送信されます</p>
            <a href="https://line.me/R/ti/p/@204zmull"
               class="block w-full bg-[#06C755] text-white py-3 rounded-xl font-bold text-sm">
                LINE追加する
            </a>
        </div>
    </div>
