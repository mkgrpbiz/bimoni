        ...
        <div class="bg-white rounded-3xl mx-4 max-w-sm w-full text-center shadow-2xl overflow-hidden">
            <div class="bg-gradient-to-br from-pink-400 to-pink-500 px-6 pt-8 pb-7">
                <div class="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-md">
                    <svg class="w-9 h-9 text-[#06C755]" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="px-6 py-7">
                ...
                <a href="https://line.me/R/ti/p/@204zmull"
                   class="block w-full bg-[#06C755] text-white py-3.5 rounded-2xl font-bold text-sm shadow-md">
                    LINE追加する
                </a>
            </div>
        </div>
